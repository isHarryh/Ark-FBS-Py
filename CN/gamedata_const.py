...
def clz_Torappu_GameDataConstsAddRichTextStyles(builder, richTextStyles):
    builder.PrependUOffsetTRelativeSlot(49, flatbuffers.number_types.UOffsetTFlags.py_type(richTextStyles), 0)
...
def clz_Torappu_GameDataConstsAddCharAssistRefreshTime(builder, charAssistRefreshTime):
    builder.PrependUOffsetTRelativeSlot(50, flatbuffers.number_types.UOffsetTFlags.py_type(charAssistRefreshTime), 0)
...
def clz_Torappu_GameDataConstsAddNormalRecruitLockedString(builder, normalRecruitLockedString):
    builder.PrependUOffsetTRelativeSlot(51, flatbuffers.number_types.UOffsetTFlags.py_type(normalRecruitLockedString), 0)
...
def clz_Torappu_GameDataConstsAddUseAssistSocialPt(builder, useAssistSocialPt):
    builder.PrependInt32Slot(63, useAssistSocialPt, 0)

def clz_Torappu_GameDataConstsAddUseAssistSocialPtMaxCount(builder, useAssistSocialPtMaxCount):
    builder.PrependInt32Slot(64, useAssistSocialPtMaxCount, 0)

def clz_Torappu_GameDataConstsAddAssistBeUsedSocialPt(builder, assistBeUsedSocialPt):
    builder.PrependUOffsetTRelativeSlot(65, flatbuffers.number_types.UOffsetTFlags.py_type(assistBeUsedSocialPt), 0)
...
def clz_Torappu_GameDataConstsAddPushForces(builder, pushForces):
    builder.PrependUOffsetTRelativeSlot(66, flatbuffers.number_types.UOffsetTFlags.py_type(pushForces), 0)
...
def clz_Torappu_GameDataConstsAddPushForceZeroIndex(builder, pushForceZeroIndex):
    builder.PrependInt32Slot(67, pushForceZeroIndex, 0)

def clz_Torappu_GameDataConstsAddNormalGachaUnlockPrice(builder, normalGachaUnlockPrice):
    builder.PrependUOffsetTRelativeSlot(68, flatbuffers.number_types.UOffsetTFlags.py_type(normalGachaUnlockPrice), 0)
...
def clz_Torappu_GameDataConstsAddPullForces(builder, pullForces):
    builder.PrependUOffsetTRelativeSlot(69, flatbuffers.number_types.UOffsetTFlags.py_type(pullForces), 0)
...
def clz_Torappu_GameDataConstsAddPullForceZeroIndex(builder, pullForceZeroIndex):
    builder.PrependInt32Slot(70, pullForceZeroIndex, 0)

def clz_Torappu_GameDataConstsAddMultiInComeByRank(builder, multiInComeByRank):
    builder.PrependUOffsetTRelativeSlot(71, flatbuffers.number_types.UOffsetTFlags.py_type(multiInComeByRank), 0)
...
def clz_Torappu_GameDataConstsAddLmtgstoEpgsratio(builder, lmtgstoEpgsratio):
    builder.PrependInt32Slot(72, lmtgstoEpgsratio, 0)

def clz_Torappu_GameDataConstsAddNewBeeGiftEpgs(builder, newBeeGiftEpgs):
    builder.PrependInt32Slot(73, newBeeGiftEpgs, 0)

def clz_Torappu_GameDataConstsAddLMtgsdescConstOne(builder, lMtgsdescConstOne):
    builder.PrependUOffsetTRelativeSlot(74, flatbuffers.number_types.UOffsetTFlags.py_type(lMtgsdescConstOne), 0)

def clz_Torappu_GameDataConstsAddLMtgsdescConstTwo(builder, lMtgsdescConstTwo):
    builder.PrependUOffsetTRelativeSlot(75, flatbuffers.number_types.UOffsetTFlags.py_type(lMtgsdescConstTwo), 0)

def clz_Torappu_GameDataConstsAddDefCdprimColor(builder, defCdprimColor):
    builder.PrependUOffsetTRelativeSlot(76, flatbuffers.number_types.UOffsetTFlags.py_type(defCdprimColor), 0)

def clz_Torappu_GameDataConstsAddDefCdsecColor(builder, defCdsecColor):
    builder.PrependUOffsetTRelativeSlot(77, flatbuffers.number_types.UOffsetTFlags.py_type(defCdsecColor), 0)

def clz_Torappu_GameDataConstsAddMailBannerType(builder, mailBannerType):
    builder.PrependUOffsetTRelativeSlot(78, flatbuffers.number_types.UOffsetTFlags.py_type(mailBannerType), 0)
...
def clz_Torappu_GameDataConstsAddStoryReviewUnlockItemLackTip(builder, storyReviewUnlockItemLackTip):
    builder.PrependUOffsetTRelativeSlot(97, flatbuffers.number_types.UOffsetTFlags.py_type(storyReviewUnlockItemLackTip), 0)

def clz_Torappu_GameDataConstsAddDataVersion(builder, dataVersion):
    builder.PrependUOffsetTRelativeSlot(98, flatbuffers.number_types.UOffsetTFlags.py_type(dataVersion), 0)

def clz_Torappu_GameDataConstsAddResPrefVersion(builder, resPrefVersion):
    builder.PrependUOffsetTRelativeSlot(99, flatbuffers.number_types.UOffsetTFlags.py_type(resPrefVersion), 0)

def clz_Torappu_GameDataConstsAddAnnounceWebBusType(builder, announceWebBusType):
    builder.PrependUOffsetTRelativeSlot(100, flatbuffers.number_types.UOffsetTFlags.py_type(announceWebBusType), 0)

def clz_Torappu_GameDataConstsAddVideoPlayerWebBusType(builder, videoPlayerWebBusType):
    builder.PrependUOffsetTRelativeSlot(101, flatbuffers.number_types.UOffsetTFlags.py_type(videoPlayerWebBusType), 0)

def clz_Torappu_GameDataConstsAddGachaLogBusType(builder, gachaLogBusType):
    builder.PrependUOffsetTRelativeSlot(102, flatbuffers.number_types.UOffsetTFlags.py_type(gachaLogBusType), 0)

def clz_Torappu_GameDataConstsAddDefaultMinContinuousBattleTimes(builder, defaultMinContinuousBattleTimes):
    builder.PrependInt32Slot(103, defaultMinContinuousBattleTimes, 0)

def clz_Torappu_GameDataConstsAddDefaultMaxContinuousBattleTimes(builder, defaultMaxContinuousBattleTimes):
    builder.PrependInt32Slot(104, defaultMaxContinuousBattleTimes, 0)

def clz_Torappu_GameDataConstsAddContinuousActionOpen(builder, continuousActionOpen):
    builder.PrependBoolSlot(105, continuousActionOpen, 0)

def clz_Torappu_GameDataConstsAddSubProfessionDamageTypePairs(builder, subProfessionDamageTypePairs):
    builder.PrependUOffsetTRelativeSlot(106, flatbuffers.number_types.UOffsetTFlags.py_type(subProfessionDamageTypePairs), 0)
...
def clz_Torappu_GameDataConstsAddClassicProtectChar(builder, classicProtectChar):
    builder.PrependUOffsetTRelativeSlot(107, flatbuffers.number_types.UOffsetTFlags.py_type(classicProtectChar), 0)
...
def clz_Torappu_GameDataConstsAddBirthdaySettingDesc(builder, birthdaySettingDesc):
    builder.PrependUOffsetTRelativeSlot(108, flatbuffers.number_types.UOffsetTFlags.py_type(birthdaySettingDesc), 0)

def clz_Torappu_GameDataConstsAddBirthdaySettingConfirmDesc(builder, birthdaySettingConfirmDesc):
    builder.PrependUOffsetTRelativeSlot(109, flatbuffers.number_types.UOffsetTFlags.py_type(birthdaySettingConfirmDesc), 0)

def clz_Torappu_GameDataConstsAddBirthdaySettingLeapConfirmDesc(builder, birthdaySettingLeapConfirmDesc):
    builder.PrependUOffsetTRelativeSlot(110, flatbuffers.number_types.UOffsetTFlags.py_type(birthdaySettingLeapConfirmDesc), 0)

def clz_Torappu_GameDataConstsAddLeapBirthdayRewardMonth(builder, leapBirthdayRewardMonth):
    builder.PrependInt32Slot(111, leapBirthdayRewardMonth, 0)

def clz_Torappu_GameDataConstsAddLeapBirthdayRewardDay(builder, leapBirthdayRewardDay):
    builder.PrependInt32Slot(112, leapBirthdayRewardDay, 0)

def clz_Torappu_GameDataConstsAddBirthdaySettingShowStageId(builder, birthdaySettingShowStageId):
    builder.PrependUOffsetTRelativeSlot(113, flatbuffers.number_types.UOffsetTFlags.py_type(birthdaySettingShowStageId), 0)

def clz_Torappu_GameDataConstsAddIsBirthdayFuncEnabled(builder, isBirthdayFuncEnabled):
    builder.PrependBoolSlot(114, isBirthdayFuncEnabled, 0)
